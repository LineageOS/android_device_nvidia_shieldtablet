...
# Assert
TARGET_OTA_ASSERT_DEVICE := shieldtablet,loki,ardbeg,yellowstone
...
# Forced shims
TARGET_LD_SHIM_LIBS := /system/vendor/lib/hw/audio.primary.tegra.so|libicu_shim.so:/system/vendor/lib/hw/camera.tegra.so|libcamera_shim.so:/system/vendor/bin/glgps_nvidiaTegra2android|libsensor.so
